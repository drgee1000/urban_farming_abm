 ...
 *
 */
public class Restaurant implements FixedGeography{
	
/** A list of agents who stay here*/
	
	private List<IAgent> agents;
	
	/** A identifier for this restaurant */
	
	private String identifier;
	

	/**
	 * The coordinates of the restaurant. This is also stored by the projection that contains this Building but it is
	...
	public String getIdentifier() throws NoIdentifierException {
		if (this.identifier == null) {
			throw new NoIdentifierException("This restaurant has no identifier. This can happen "
	...
	public String toString() {
		return "restaurant: " + this.identifier;
	}
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof Restaurant))
			return false;
		Restaurant b = (Restaurant) obj;
		return this.identifier.equals(b.identifier);
	}
	
	
	/**
	 * Return this restaurant unique id number.
	 */
	@Override
	public int hashCode() {
