 ...
 *
 */
public class Candidate3 implements FixedGeography{
	
	private static Logger LOGGER = Logger.getLogger(Candidate3.class.getName());
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof Candidate3))
			return false;
		Candidate3 b = (Candidate3) obj;
	...
	public int isRes() {
		...
		Geometry location = ContextManager.candidate3Projection.getGeometry(this);
