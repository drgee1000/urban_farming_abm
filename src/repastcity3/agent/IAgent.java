...
public interface IAgent {
	...
	/**
	 * (Optional). Get the transport options available to this agent. E.g. an agent
	 * with a car who also could use public transport would return
	 * <code>{"bus", "car"}</code>. If null then it is assumed that the agent walks
	 * (the slowest of all transport methods).
	 */
